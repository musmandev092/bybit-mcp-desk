...
from bybit_mcp_desk.handlers import (
    amend_order,
    cancel_order,
    place_order,
)
...
def test_place_and_cancel_linear_limit_order():
    ...
    try:
        ...
        place_response = place_order(category=category, symbol=symbol, side=side, orderType=orderType, qty=qty, price=price, orderLinkId=orderLinkId)
...
def test_place_amend_and_cancel_linear_limit_order():
    ...
    try:
        ...
        place_response = place_order(category=category, symbol=symbol, side=side, orderType=orderType, qty=initial_qty, price=initial_price, orderLinkId=orderLinkId)
